...
class _View_ErrorComponent0 extends import1.AppView<import3.ErrorComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_2,'class','backdrop');
    ...
    this.renderer.setElementAttribute(this._el_4,'class','modal');
    this.renderer.setElementAttribute(this._el_4,'role','dialog');
    this.renderer.setElementAttribute(this._el_4,'tabindex','-1');
    this._NgStyle_4_3 = new import11.NgStyle(this.parentInjector.get(import12.KeyValueDiffers),new import13.ElementRef(this._el_4),this.renderer);
    ...
    this.renderer.setElementAttribute(this._el_10,'class','modal-header');
    this._text_11 = this.renderer.createText(this._el_10,'\n                ',(null as any));
    this._text_12 = this.renderer.createText(this._el_10,'\n                ',(null as any));
    this._el_13 = this.renderer.createElement(this._el_10,'button',(null as any));
    this.renderer.setElementAttribute(this._el_13,'aria-label','Close');
    this.renderer.setElementAttribute(this._el_13,'class','close');
    this.renderer.setElementAttribute(this._el_13,'type','button');
    this._el_14 = this.renderer.createElement(this._el_13,'span',(null as any));
    this.renderer.setElementAttribute(this._el_14,'aria-hidden','true');
    ...
    this._el_18 = this.renderer.createElement(this._el_10,'h4',(null as any));
    this.renderer.setElementAttribute(this._el_18,'class','modal-title');
    ...
    this.renderer.setElementAttribute(this._el_22,'class','modal-body');
    this._text_23 = this.renderer.createText(this._el_22,'\n                ',(null as any));
    this._text_24 = this.renderer.createText(this._el_22,'\n                ',(null as any));
    this._el_25 = this.renderer.createElement(this._el_22,'p',(null as any));
    ...
    this._el_29 = this.renderer.createElement(this._el_8,'div',(null as any));
    this.renderer.setElementAttribute(this._el_29,'class','modal-footer');
    this._text_30 = this.renderer.createText(this._el_29,'\n                ',(null as any));
    this._text_31 = this.renderer.createText(this._el_29,'\n                ',(null as any));
    this._el_32 = this.renderer.createElement(this._el_29,'button',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import11.NgStyle) && (2 === requestNodeIndex))) { return this._NgStyle_2_3; }
    if (((token === import11.NgStyle) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 37)))) { return this._NgStyle_4_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import4.checkBinding(throwOnChange,this._expr_4,currVal_4)) {
      this.renderer.setText(this._text_26,currVal_4);
...
export function viewFactory_ErrorComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ErrorComponent> {
  if ((renderType_ErrorComponent === (null as any))) { (renderType_ErrorComponent = viewUtils.createRenderComponentType('/Users/alex/code/wdi/project/gowhere/assets/app/errors/error.component.html',0,import9.ViewEncapsulation.Emulated,styles_ErrorComponent,{})); }
