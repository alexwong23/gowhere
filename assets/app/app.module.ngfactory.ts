...
import * as import31 from './errors/error.service';
import * as import32 from './auth/auth.service';
import * as import33 from './acts/act.service';
import * as import34 from 'angular2-jwt/angular2-jwt';
import * as import35 from '@angular/core/src/di/injector';
import * as import36 from './acts/main.component.ngfactory';
import * as import37 from './acts/act-input.component.ngfactory';
import * as import38 from './auth/signup.component.ngfactory';
import * as import39 from './auth/signin.component.ngfactory';
import * as import40 from './my/my-events/my-events.component.ngfactory';
import * as import41 from './acts/act-edit.component.ngfactory';
import * as import42 from './auth/authentication.component.ngfactory';
...
import * as import51 from './acts/main.component';
import * as import52 from './acts/act-input.component';
import * as import53 from './auth/signup.component';
import * as import54 from './auth/signin.component';
import * as import55 from './my/my-events/my-events.component';
import * as import56 from './acts/act-edit.component';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __ErrorService_52:import31.ErrorService;
  __AuthService_53:import32.AuthService;
  __ActService_54:import33.ActService;
  __AUTH_PROVIDERS_55:import34.AUTH_PROVIDERS;
  constructor(parent:import35.Injector) {
    super(parent,[
      import36.MainComponentNgFactory,
      import37.ActInputComponentNgFactory,
      import38.SignupComponentNgFactory,
      import39.SigninComponentNgFactory,
      import40.MyEventsComponentNgFactory,
      import41.ActEditComponentNgFactory,
  ...
  get _APP_ID_18():any {
    if ((this.__APP_ID_18 == (null as any))) { (this.__APP_ID_18 = import44._appIdRandomProviderFactory()); }
  ...
  get _EventManager_22():import15.EventManager {
    if ((this.__EventManager_22 == (null as any))) { (this.__EventManager_22 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_21,this.parent.get(import47.NgZone))); }
  ...
  get _RootRenderer_26():any {
    if ((this.__RootRenderer_26 == (null as any))) { (this.__RootRenderer_26 = import48._createConditionalRootRenderer(this._DomRootRenderer_25,this.parent.get(import48.NgProbeToken,(null as any)))); }
  ...
  get _LocationStrategy_43():any {
    if ((this.__LocationStrategy_43 == (null as any))) { (this.__LocationStrategy_43 = import7.provideLocationStrategy(this.parent.get(import49.PlatformLocation),this.parent.get(import50.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_42)); }
  ...
  get _ROUTES_48():any[] {
      if ((this.__ROUTES_48 == (null as any))) { (this.__ROUTES_48 = [[
        {
          path: '',
          component: import51.MainComponent,
          pathMatch: 'full'
        }
        ,
        {
          path: 'new',
          component: import52.ActInputComponent
        }
        ,
        {
          path: 'signup',
          component: import53.SignupComponent
        }
        ,
        {
          path: 'signin',
          component: import54.SigninComponent
        }
        ,
        {
          path: 'myevents',
          component: import55.MyEventsComponent
        }
        ,
        {
          path: 'myevents/:id/edit',
          component: import56.ActEditComponent
        }
        ,
        {
          path: 'auth',
  ...
  get _Router_49():any {
    if ((this.__Router_49 == (null as any))) { (this.__Router_49 = import7.setupRouter(this._ApplicationRef_16,this._UrlSerializer_45,this._RouterOutletMap_46,this._Location_44,this,this._NgModuleFactoryLoader_47,this._Compiler_17,this._ROUTES_48,this._ROUTER_CONFIGURATION_42)); }
    return this.__Router_49;
  }
  get _ActivatedRoute_50():any {
    if ((this.__ActivatedRoute_50 == (null as any))) { (this.__ActivatedRoute_50 = import7.rootRoute(this._Router_49)); }
    return this.__ActivatedRoute_50;
  }
  get _APP_BOOTSTRAP_LISTENER_51():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_51 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_51 = [import7.initialRouterNavigation(this._Router_49,this._ROUTER_CONFIGURATION_42)]); }
    return this.__APP_BOOTSTRAP_LISTENER_51;
  }
  get _ErrorService_52():import31.ErrorService {
    if ((this.__ErrorService_52 == (null as any))) { (this.__ErrorService_52 = new import31.ErrorService()); }
    return this.__ErrorService_52;
  }
  get _AuthService_53():import32.AuthService {
    if ((this.__AuthService_53 == (null as any))) { (this.__AuthService_53 = new import32.AuthService(this._Http_41,this._ErrorService_52)); }
    return this.__AuthService_53;
  }
  get _ActService_54():import33.ActService {
    if ((this.__ActService_54 == (null as any))) { (this.__ActService_54 = new import33.ActService(this._Http_41,this._ErrorService_52)); }
    return this.__ActService_54;
  }
  get _AUTH_PROVIDERS_55():import34.AUTH_PROVIDERS {
    if ((this.__AUTH_PROVIDERS_55 == (null as any))) { (this.__AUTH_PROVIDERS_55 = new import34.AUTH_PROVIDERS()); }
    return this.__AUTH_PROVIDERS_55;
  }
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_5 = import7.provideForRootGuard(this.parent.get(import58.Router,(null as any)));
    ...
    this._ApplicationRef__15 = new import12.ApplicationRef_(this.parent.get(import47.NgZone),this.parent.get(import59.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_13,this.parent.get(import11.TestabilityRegistry,(null as any)),this._Testability_14);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import44.APP_ID)) { return this._APP_ID_18; }
    ...
    if ((token === import7.ROUTER_CONFIGURATION)) { return this._ROUTER_CONFIGURATION_42; }
    if ((token === import50.LocationStrategy)) { return this._LocationStrategy_43; }
    ...
    if ((token === import44.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_51; }
    if ((token === import31.ErrorService)) { return this._ErrorService_52; }
    if ((token === import32.AuthService)) { return this._AuthService_53; }
    if ((token === import33.ActService)) { return this._ActService_54; }
    if ((token === import34.AUTH_PROVIDERS)) { return this._AUTH_PROVIDERS_55; }
